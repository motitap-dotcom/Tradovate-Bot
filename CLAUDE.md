...
### כללים מחייבים:
- **אין לך גישה לשרת.** אל תנסה ping, curl, ssh, בדיקות רשת, או כל אבחון מרחוק. זה לא יעבוד.
- **אל תשאל "אתה רוצה שאכתוב סקריפט?"** — פשוט תעשה מה שהמשתמש מבקש.
- **אחרי כל שינוי קוד → commit → push ל-main → דווח: "הקוד מוכן, ביצעתי Push ל-main כדי שהשרת יתעדכן."**
- **המשתמש יודע מה הוא עושה.** אל תסביר לו את זרימת העבודה — פשוט תבצע.
