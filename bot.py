"""
Tradovate Trading Bot — v2.4 (never-die, REST-only)
======================
    ...
    def _main_loop(self):
        ...
        while self.running:
            try:
                ...
                # NOTE: WebSocket recovery disabled — Tradovate WS connects and
                # authenticates but delivers no usable quote data (contractId=None).
                # REST polling via Yahoo Finance is reliable and proven.
